...
class AutoSpider(scrapy.Spider):
    ...
    def parse(self, response):
        ...
        CITROEN = response.xpath(
            '//*[@id="js-hook-for-listen-scroll-cta"]/div[1]/ul[2]/li/ul/li[11]/a/@href').get()  # citroen
        HONDA = response.xpath(
            '//*[@id="js-hook-for-listen-scroll-cta"]/div[1]/ul[2]/li/ul/li[21]/a/@href').get()  # honda
